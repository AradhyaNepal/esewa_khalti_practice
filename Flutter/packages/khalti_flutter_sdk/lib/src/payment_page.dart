...
class PaymentPage extends StatelessWidget {
  ...
  // final List<PaymentPreference> preferences; Commented from original code because not needed
        ...
        child: PaymentConfigScope(
          ...
          child: KhaltiService.publicKey.startsWith('test_')
              ? Banner(
                  ...
                  child: const _MainPage(preferences: [PaymentPreference.khalti]),
                )
              : const _MainPage(preferences: [PaymentPreference.khalti]),
        ),
      ),
    );
  }
          ...
          body: AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            child: SafeArea(
              child: NestedScrollView(
                ...
                body: _getView(PaymentPreference.khalti)
                // TabBarView(
